...
BEGIN
  ...
  EXECUTE IMMEDIATE 'DROP TABLE administrators_mgs';
  EXECUTE IMMEDIATE 'DROP TABLE order_items_mgs';
  EXECUTE IMMEDIATE 'DROP TABLE orders_mgs';
  EXECUTE IMMEDIATE 'DROP TABLE products_mgs';
  EXECUTE IMMEDIATE 'DROP TABLE categories_mgs';
  EXECUTE IMMEDIATE 'DROP TABLE addresses_mgs';
...
-- Create the tables
CREATE TABLE categories_mgs (
  category_id        NUMBER         PRIMARY KEY,
  category_name      VARCHAR2(255)  NOT NULL      UNIQUE
);

CREATE TABLE products_mgs (
  product_id         NUMBER         PRIMARY KEY,
  category_id        NUMBER         REFERENCES categories_mgs (category_id),
...
INSERT INTO categories_mgs (category_id, category_name) VALUES
(1, 'Guitars');
INSERT INTO categories_mgs (category_id, category_name) VALUES
(2, 'Basses');
INSERT INTO categories_mgs (category_id, category_name) VALUES
...
INSERT INTO products_mgs (product_id, category_id, product_code, product_name, description, list_price, discount_percent, date_added) VALUES
...
INSERT INTO addresses_mgs (address_id, customer_id, line1, line2, city, state, zip_code, phone, disabled) VALUES
...
INSERT INTO order_items_mgs (item_id, order_id, product_id, item_price, discount_amount, quantity) VALUES
...
INSERT INTO administrators_mgs (admin_id, email_address, password, first_name, last_name) VALUES
